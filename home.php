...
<body>
	 ...
	 <button type="submit"  name="show" >عرض البيانات</button>
	 
	<button type="submit"   name="delete" onclick="delete1()">حذف البيانات </button>
	 <div id="myDIV"> 
...
function delete1() {
  ...
  if (x.style.display === "none") {
    ...
    x.style.display = "none";
	 ...
	 <button type="submit"  name="add" onclick="add()">إضافة بيانات</button>
	 <div id="myDIV1"> 
